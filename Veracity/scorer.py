...
if('subtaska' in truth_values and len(truth_values['subtaska'])>0):
 if('subtaskaenglish' in submission and len(submission['subtaskaenglish'])>0):
  correct, total = calculate_a_score(truth_values['subtaska'], submission['subtaskaenglish'])
  acorrect += correct
  atotal += total
...
if('subtaskb' in truth_values and len(truth_values['subtaskb'])>0):
 if('subtaskbenglish' in submission and len(submission['subtaskbenglish'])>0):
  correct, total, sumerrors, lenerrors = calculate_b_score(truth_values['subtaskb'], submission['subtaskbenglish'])
...
bscore = 0
brmse = 0
if(fullsetpresent==1 or atotal>0 or btotal>0):
